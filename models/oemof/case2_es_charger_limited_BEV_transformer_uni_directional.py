...
class EnergySystemModel:
    ...
    def create_oemof_objects(self):
        ...
        # Wallbox as Converter
        wallbox = cmp.Converter(
            label="wallbox",
        ...
        self.es.add(
            cmp.Sink(label="excess_bel", inputs={b_el: flows.Flow(variable_costs=Grid_feed_in_costs)})
        )
        ...
        BEV = cmp.GenericStorage(
            ...
            outputs={b_bev: flows.Flow(variable_costs=15)},
...
if __name__ == "__main__":
    Energysystem = EnergySystemModel("case3_es_charger_limited_BEV_transformer_uni_directional")
